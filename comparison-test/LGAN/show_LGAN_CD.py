...
parser.add_argument('--model', type=str, default='Trained_Recon_Model_LGAN_5views/LGAN_ae55.pth', help='model path')
...
#    real_center_key =real_center_key.cuda()
    dist_all, dist1, dist2 = criterion_PointLoss(fake_center,real_center)#change this to show cd on whole shape or part shape
